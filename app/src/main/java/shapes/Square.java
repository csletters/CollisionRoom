...
//		GLES20.glVertexAttribPointer(Shader.normalHandle, 3, GLES20.GL_FLOAT, false,0, 0);
    ...
    //texture draw
    public void drawWnormals( float[] projection, float[] view, float[] model, ShaderHandles Shader, int textures)
    {
...
//		//normals
    ...
    //texture draw
    public void drawWnormalsNoTexture( float[] projection, float[] view, float[] model, ShaderHandles Shader)
    {
